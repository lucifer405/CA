    ...
    <div className="main-container">
        <div className='signup-container'>
            ...
            <form onSubmit={submitting}>
                ...
                <input type="text" name="mobile" id="mobile"  placeholder="Enter Mobilenumber" value={valuee.mobile} onChange={assignValues}></input><br />
            ...
            <footer className='footer'>
                <p>Already a Admin? <Link to='/login' className='link'>Login</Link></p>
            </footer>
            </div>  
        </div>
    </div> 
