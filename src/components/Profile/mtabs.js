        ...
        >
            <Tab eventKey="home" title="Basic Details" className="p-4" onSubmit={submitting}>
                ...
                <div className="row mt-0">
                    ...
                    <div className="col-md-12 p-2"><label className="labels">Spouse Name</label><input type="text" name="spouse" id="spouse" className="form-control" placeholder="enter name" value={valuee.spouse} onChange={assignValues} /></div>
                    <div className="col-md-12 p-2"><label className="labels">Child Name</label><input type="text" name="spouse" id="spouse" className="form-control" placeholder="enter name 1" value={valuee.spouse} onChange={assignValues} /></div>
                    <div className="col-md-12 p-2"><input type="text" name="spouse" id="spouse" className="form-control" placeholder="enter name 2" value={valuee.spouse} onChange={assignValues} /></div>
                ...
                <br></br>
                <div className="row mt-0 py-2" required=    "True">
