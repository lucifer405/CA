        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="me-auto">
            ...
            <NavDropdown title="Facilities" id="collasible-nav-dropdown">
              <NavDropdown.Item href="/admin/cafesAndRestaurants">Cafe and Restaurants</NavDropdown.Item>
              <NavDropdown.Item href="/admin/hotels">Hotels</NavDropdown.Item>
              <NavDropdown.Item href="/admin/travels">Travels and Tours</NavDropdown.Item>
              <NavDropdown.Item href="/admin/jobs">Jobs</NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item href="/admin/moreInfo">More...</NavDropdown.Item>
            </NavDropdown>
            <Nav.Link href="/admin/members" style={{color:"white"}}>Members</Nav.Link>
            {/* <Nav.Link href="/admin/gallery" style={{color:"white"}}>Gallery</Nav.Link> */}
            <Nav.Link href="/admin/post" style={{color:"white"}}>Posts</Nav.Link>
            <Nav.Link href="/admin/about" style={{color:"white"}}>About Us</Nav.Link>
            <Nav.Link href="/admin/contact" style={{color:"white"}}>Contact Us</Nav.Link>
          </Nav>
          <Nav>
